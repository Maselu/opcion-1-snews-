/*
  # Interactive Forum Database Schema

  ## Overview
  Complete database schema for an interactive forum application with articles, comments, likes, topics, and weather integration.

  ## Tables Created

  ### 1. Categories
  - `id` (integer, primary key, auto-increment)
  - `name` (text, unique, not null) - Category name (News, Sports, Weather, Entertainment)
  ...
  - `topic_id` (integer, foreign key to topics, nullable)
  - `parent_comment_id` (integer, foreign key to comments, nullable for threaded replies)
  - `content` (text, not null)
  ...
  - `data` (jsonb, not null) - Weather data from AEMET API
